...
type RepositoryWrap struct {
	Repositories []*Repository `xml:"repositorySet"`
}
...
type Repository struct {
	...
	RepositoryName *LegalBodyRef `xml:"repositoryName"`

...
type MeasurementsWrap struct {
	MeasurementsSets []*MeasurementsSet `xml:"objectMeasurementsSet"`
}
...
type MeasurementsSet struct {
	...
	DisplayObjectMeasurements []*Text `xml:"displayObjectMeasurements"`
	...
	ObjectMeasurements *Measurements `xml:"objectMeasurements"`
...
type Measurements struct {
	...
	FormatMeasurements []*ExtentMeasurement `xml:"formatMeasurements"`
	...
	ShapeMeasurements []*ExtentMeasurement `xml:"shapeMeasurements"`
	...
	ScaleMeasurements []*ExtentMeasurement `xml:"scaleMeasurements"`
	...
	MeasurementsSets []*AspectMeasurements `xml:"measurementsSet"`
	...
	ExtentMeasurements []*ExtentMeasurement `xml:"extentMeasurements"`
	...
	QualifierMeasurements []*ExtentMeasurement `xml:"qualifierMeasurements"`
}
...
type AspectMeasurements struct {
	...
	MeasurementTypes []*Text `xml:"measurementType"`
